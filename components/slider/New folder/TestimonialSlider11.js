            ...
            <Swiper {...swiperOptions} className="theme_carousel owl-theme">
                <SwiperSlide className="slide-item">
                    <div className="inner-box">
                        ...
                        <figure className="thumb-box"><img src="/assets/images-2/resource/testimonial-8.png" alt="" /></figure>
                ...
                <SwiperSlide className="slide-item">
                    <div className="inner-box">
                        <div className="icon-box"><i className="fas fa-quote-left" /></div>
                        <figure className="thumb-box"><img src="/assets/images-2/resource/testimonial-9.png" alt="" /></figure>
